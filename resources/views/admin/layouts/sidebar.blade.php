...
<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="{{route('manager.index')}}"><img src="{{asset('admin/assets/images/logo.svg')}}" alt="logo"></a>
        <a class="navbar-brand brand-logo-mini" href="{{route('manager.index')}}"><img src="{{asset('admin/assets/images/logo-mini.svg')}}" alt="logo"></a>
    ...
    <ul class="nav">
        ...
        <li class="nav-item menu-items ">
            <a class="nav-link" href="{{route('manager.education.list')}}">
              <span class="menu-icon">
        ...
        <li class="nav-item menu-items ">
            <a class="nav-link" href="{{route('manager.experince.list')}}">
              <span class="menu-icon">
